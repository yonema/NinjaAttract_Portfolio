...
- [6.困難だった点と解決方法](#6困難だった点と解決方法)
  - [6.1.広範囲マップでの影の問題](#61広範囲マップでの影の問題)
  - [6.2.VSMの注意点](#62vsmの注意点)
  - [6.3.D3D12のエラー、警告の回避](#63d3d12のエラー警告の回避)
  - [6.4.VRoidから自作ゲームで表示できるモデルデータへの変換](#64vroidから自作ゲームで表示できるモデルデータへの変換)
- [7.技術紹介](#7技術紹介)
  ...
  - [7.7.LOD](#77lod)
  - [7.8.FlyWeightパターン](#78flyweightパターン)
  - [7.9.ベジェ曲線](#79ベジェ曲線)
...
## 6.4.VRoidから自作ゲームで表示できるモデルデータへの変換
